...
if __name__=="__main__":
    ...
    chosen_dir = current_working_dir.rstrip("/CamVid")
    replace("test.txt", "test_fixed.txt", chosen_dir)
    replace("train.txt", "train_fixed.txt", chosen_dir)
    replace("val.txt", "val_fixed.txt", chosen_dir)
